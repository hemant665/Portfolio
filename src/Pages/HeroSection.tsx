...
const HeroSection = () => {
  return (
    <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 mt-7 gap-4 overflow-hidden">
      <div className="w-full h-full flex flex-col gap-3 lg:gap-5 xl:gap-9">
        ...
        <div className="flex flex-col sm:flex-row gap-5  lg:h-[3rem]">
          <Button
            ...
            variant="effects"
          />
          <Button value="View Works" className="bg-white h-[3rem] w-[10rem]" variant="simple" />
        </div>
      ...
      <div className="w-full h-full flex items-center justify-center lg:justify-end p-5 ">
        <div className=" shadow-md shadow-[#1C45E3] rounded-2xl flex items-center justify-center w-[25rem] p-3">
